"""
Script Service → The Alchemist / Gemini Cortex
Generates branded content scripts using Gemini 2.5 with Langfuse tracing.
"""
import json
import uuid
...
Return ONLY valid JSON, no markdown."""
        ...
        return self.gemini.invoke_model_json(prompt, system=system, agent_name=AGENT_NAME)
