...
import { Sparkles, CalendarDays, MessageCircle, TrendingUp, AlertCircle, Rocket, Image as ImageIcon, Film, Shield, ShieldCheck, ShieldAlert, Loader2, Send, CheckCircle2 } from "lucide-react";
import { enterpriseApi } from "@/lib/api";

const ENTERPRISE_ID = "00000000-0000-0000-0000-000000000000"; // Target generic account
...
export default function CampaignStrategistPage() {
    ...
    return (
        <div className="flex-1 w-full flex flex-col items-center justify-start p-8 bg-[#fbfbfa]">
            <div className="w-full max-w-3xl mb-8 text-center pt-10">
                ...
                <p className="text-lg text-gray-500 font-medium max-w-xl mx-auto">
                    Tell us what you are launching. Our AI reads your ingested Enterprise facts mapping out a timeline, scripts, and engagement playbook.
                </p>
            </div>

            <div className="w-full max-w-2xl bg-white p-8 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-gray-100 mb-12">
                <div className="flex flex-col gap-4">
                    <label className="text-sm font-bold text-gray-900 ml-1">What is the objective?</label>
                    <textarea
                        value={goal}
                        onChange={(e) => setGoal(e.target.value)}
                        placeholder="e.g. Next month's massive product launch for the new Q4 Analytics Tool. Build hype and drive signups."
                        className="w-full p-6 text-lg bg-gray-50/50 rounded-2xl border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-violet-500 placeholder-gray-400 outline-none transition-shadow resize-none h-36 font-medium text-gray-800"
                    />
                    <button
