            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest mb-4 shadow-sm border border-violet-100"
                        ...
                        <Sparkles size={12} /> Powered by Enflomnia Ecosystem
                    </div>
                    <h1 className="text-4xl font-extrabold text-gray-900 tracking-tighter mb-2">
                        {account?.username ? `Welcome, ${account.username}!` : "Welcome, Strategist!"}
                    </h1>
                    <p className="text-gray-500 font-medium max-w-md">
                        The Self-Evolving Content Nervous System is pulse-checking your enterprise data.
                    </p>
                </div>
            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <StatCard label="Policy Violations" value={threats} subtext="Compliance & Safety" color="#dc2626" />
                        <StatCard
                            label="System Pulse"
                            value={reachStatus?.is_anomaly ? "Alert" : "Stable"}
                            subtext={reachStatus?.is_anomaly ? (reachStatus.anomaly_type || "anomaly detected") : "100% Brand Safety"}
                            color={reachStatus?.is_anomaly ? "#d97706" : "#059669"}
                        />
                        <StatCard label="Strategic Loops" value={suggestions.length} subtext="Agentic cycles" color="#7c3aed" />
                    </div>
                        ...
                        <div className="card flex flex-col gap-6 shadow-md border-violet-50">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="font-black text-gray-900 tracking-tight uppercase text-xs">The Aegis</h2>
                                </div>
                            ...
                            <div className="space-y-3">
                                {[
                                    { label: "Risk Mitigated", count: comments?.spam || 0, color: "#dc2626", bg: "#fee2e2" },
                                    { label: "Compliance Check", count: comments?.toxic || 0, color: "#d97706", bg: "#fef3c7" },
                                    { label: "Legal Guard", count: comments?.bot || 0, color: "#7c3aed", bg: "#ede9fe" },
                            ...
                            <div className="mt-auto pt-4 border-t border-gray-100">
                                <Link href="/dashboard/reach" className="flex items-center justify-between group">
                                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Sentinel Immune Status</span>
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className={`text-[10px] font-bold uppercase tracking-widest ${reachStatus?.is_anomaly ? 'text-amber-600' : 'text-emerald-600'}`}>
                                            {reachStatus?.is_anomaly ? "Auto-Correcting" : "Active / Safe"}
                                        </span>
                                    </div>
                                </Link>
                            </div>
                        ...
                        <div className="card flex flex-col gap-6 shadow-md border-emerald-50">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="font-black text-gray-900 tracking-tight uppercase text-xs">The Alchemist</h2>
                                </div>
                            ...
                            <p className="text-xs text-gray-500 leading-relaxed font-medium">
                                Collapse the 10-day cycle. Use a first-principles approach to render 1,000+ branded assets in milliseconds.
                            </p>

                                <div className="space-y-2">
                                    {[
                                        { href: "/dashboard/accelerator/pricing", icon: Film, label: "Remotion Engine", color: "#10b981" },
                                        { href: "/dashboard/accelerator/scripts", icon: BrainCircuit, label: "Gemini Cortex", color: "#7c3aed" },
                                        { href: "/dashboard/accelerator/matching", icon: Star, label: "Imagen 4 Studio", color: "#f59e0b" },
                        ...
                        <div className="card flex flex-col gap-6 shadow-md border-violet-50 bg-gradient-to-br from-white to-violet-50/20">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="font-black text-gray-900 tracking-tight uppercase text-xs">The DNA & Soil</h2>
                                </div>
                            ...
                            {suggestions.length > 0 ? (
                                <div className="rounded-2xl p-4 space-y-3 bg-white border border-violet-100 shadow-sm grow">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[9px] font-black uppercase tracking-widest text-violet-400">Enterprise Context</span>
                                    </div>
                            ...
                            <Link href="/dashboard/workload"
                                ...
                                <div className="flex items-center gap-3">
                                    <Zap size={15} />
                                    <span className="text-xs font-black uppercase tracking-widest">The Pulse: Feedback</span>
                                </div>
                    ...
                    <div className="card bg-gray-900 text-white flex flex-col md:flex-row items-center justify-between p-8 shadow-xl">
                        <div className="flex items-center gap-6 mb-4 md:mb-0">
                            ...
                            <div>
                                <h3 className="text-xl font-black tracking-tight">Autonomous Loop</h3>
                                <p className="text-sm text-gray-400 font-medium">Synchronize your enterprise media engine with global market sentiment.</p>
                            </div>
                        </div>
