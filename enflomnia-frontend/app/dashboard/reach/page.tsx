...
const STATUS_MAP = {
    none: { color: "#059669", bg: "#d1fae5", label: "System Pulse is Optimal", icon: CheckCircle },
    creator_specific: { color: "#d97706", bg: "#fef3c7", label: "Localized Anomaly Detected", icon: AlertTriangle },
    platform_wide: { color: "#dc2626", bg: "#fee2e2", label: "Global Platform Turbulence", icon: TrendingDown },
};
        ...
        <div className="p-8 max-w-5xl mx-auto space-y-8">
            ...
            <div className="flex items-start justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2.5 mb-1.5">
                        ...
                        System Pulse: Sentinel Monitor
                    </h1>
                    <p className="text-sm text-gray-500 max-w-lg">
                        Enflomnia's Sentinel layer monitors global reach patterns in real-time, detecting platform-wide anomalies and trend shifts.
                    </p>
                </div>
                <div className="flex gap-3">
                    ...
                    <button onClick={handleSync} disabled={syncing}
                        ...
                        {syncing ? "Calibrating Pulse..." : "Nervous System Sync"}
                    </button>
                </div>
            </div>
                        ...
                        {analysis.baseline_reach && (
                            <div className="flex gap-6 mt-5 py-4 border-t border-gray-100">
                                <div className="space-y-1">
                                    <p className="text-[10px] uppercase font-black text-gray-400 tracking-widest">Baseline Resonance</p>
                                ...
                                <div className="space-y-1 border-l pl-6 border-gray-100">
                                    <p className="text-[10px] uppercase font-black text-gray-400 tracking-widest">Current Amplitude</p>
            ...
            <div className="card p-8">
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-xs font-black uppercase tracking-widest text-gray-400">Pulse Amplitude</h2>
